...
def validate_runtime_paths() -> None:
    ...
    required = [
        ...
        PLUGIN_ROOT / "guardian_runtime" / "src" / "guardian" / "catalog_integrity.py",
        PLUGIN_ROOT / "guardian_runtime" / "src" / "guardian" / "catalog_verify.py",
        PLUGIN_ROOT / "guardian_runtime" / "src" / "guardian" / "openssf_intel.py",
        PLUGIN_ROOT / "guardian_runtime" / "src" / "guardian" / "registry_intel.py",
        PLUGIN_ROOT / "guardian_runtime" / "src" / "guardian" / "lockfile_hygiene.py",
